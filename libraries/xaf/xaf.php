...
// Init XAFLoader.Class
require_once (realpath(dirname(__FILE__)) . '/core/xafloader.class.php');
 ...
 * @return void
 */
function xaf_import($path, $config)
{
	return XAFLoader::import($path, $config);
}
...
{
	xaf_import('core.xaplatform', 'once');
}
